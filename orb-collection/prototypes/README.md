...
- `tradovate_session_orb.js` — Tradovate custom indicator: Globex/Asia/London/NY AM sessions with 5/15/30/60m ORB levels, sweep markers (GBX/AS/LDN/NY/PD/PW), and an invisible backend signal engine (VWAP accumulation, Rule 1 IBH/IBL wick-rejection, Rule 4 VWAP/ORB-5 convergence pivot, ORB-5 breakout detection).
